...
class LeagueApiService {
  ...
  static Future<List<League>> fetchLeagues(String countryKey) async {
    try {
      Response response = await _dio.get(
        'https://apiv2.allsportsapi.com/football/?met=Leagues&APIkey=37b8927045369ddb6e0c484d1bbf164f8c0b7643e64d402f50c8608d75ce39ad&countryId=$countryKey',
      );
